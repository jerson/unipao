...
import {StyleProp, StyleSheet, SwitchProperties, Text, TextStyle, View, ViewStyle} from 'react-native';
...
export default class InputSwitch extends React.Component<InputSwitchProps,
    State> {
    state: State = {
        value: false
    };
