...
import {Alert, Dimensions, Image, Platform, ScrollView, StatusBar, StyleSheet, Text, View} from 'react-native';
...
export default class ProfileScreen extends React.Component<ProfileScreenProps,
    State> {
    static contextTypes = {
